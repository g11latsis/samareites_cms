            ...
            <div class="bg-light p-2 mt-4 d-flex justify-content-between align-items-center search-bar" style="min-width: 596px;">
                <div class="d-flex justify-content-between">
                  ...
                  border-radius: 0px;" type="search"
                    ...
                    <a href="{{ url('/ra/service') }}">
                        <button class="btn btn-outline-primary rounded">Επαναφορά</button>
                    </a>
                </div>
                <a href="{{ route('raService.index', ['url' => route('raService.store')]) }}"><button class="btn btn-primary rounded "
                    ...
                    <div class="col-lg-3 col-md-6 card d-flex justify-content-center">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('ra.service.profile', ['id' => $service->id]) }}">Λεπτομέριες</a></li>
                                <li><a class="dropdown-item" href="{{ route('raService.edit', $service->id) }}">Επεξεργασία</a></li>
                                <form action="{{ route('raService.destroy', $service->id) }}" method="POST">

      ...
      {{--  --}}
        ...
        <div class="container-fluid">
            ...
            <div class="add-ra-main">
                <div class="container">
                    <h2 class="text-center mb-4">Προσθήκη εθελοντή</h2>
                    <form action="{{ route('raUser.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            {{-- personal info --}}
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="mName" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('mName') }}">
                                <span class="text-danger">
                                    @error('mName')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="date" name="dor" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('dor') }}">
                                <span class="text-danger">
                                    @error('dor')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="date" name="doo" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('doo') }}">
                                <span class="text-danger">
                                    @error('doo')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="bloodType" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('bloodType') }}">
                                <span class="text-danger">
                                    @error('bloodType')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <span class="text-danger" value="{{ old('spec') }}">
                                    @error('spec')
                                    {{ $message }}
                                    @enderror
                                </span>
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="attr" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                <span class="text-danger" value="{{ old('attr') }}">
                                    @error('attr')
                                    {{ $message }}
                                    @enderror
                                </span>
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="lvl" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                <span class="text-danger" value="{{ old('lvl') }}">
                                    @error('lvl')
                                    {{ $message }}
                                    @enderror
                                </span>
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="prof" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                <span class="text-danger" value="{{ old('prof') }}">
                                    @error('prof')
                                    {{ $message }}
                                    @enderror
                                </span>
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="gen" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                <span class="text-danger" value="{{ old('gen') }}">
                                    @error('gen')
                                    {{ $message }}
                                    @enderror
                                </span>
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="register" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('register') }}">
                                <span class="text-danger">
                                    @error('register')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" name="passport" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('passport') }}">
                                <span class="text-danger">
                                    @error('passport')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                <label for="exampleInputEmail1" class="form-label">Περιοχή
                                    :</label>
                                <input type="text" name="region" class="form-control" aria-describedby="emailHelp"
                                    id="raUserRegion" value="{{ session('ra')->region }}" onkeyup="validate(this)" readonly>
                                <span class="text-danger">
                                    @error('region')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="langs" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('langs') }}">
                                <span class="text-danger">
                                    @error('langs')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="hrs" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('hrs') }}">
                                <span class="text-danger">
                                    @error('hrs')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="awards" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('awards') }}">
                                <span class="text-danger">
                                    @error('awards')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="penalties" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ old('penalties') }}">
                                <span class="text-danger">
                                    @error('penalties')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xl-6 col-md-12 mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="file" style="height: 4.1vh" class="form-control" name="img"
                                        id="formFile">
                                </div>
                                <span class="text-danger">
                                    @error('img')

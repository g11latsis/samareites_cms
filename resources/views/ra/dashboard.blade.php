...
@php
    ...
    $alerts = Alert::whereNotNull('desc2')->where("to2", session('ra')->id)->where('trashedbyra', null)->orderby('created_at', 'DESC')->get();
    $seen = true;
...
<div class="container-fluid row">
  <div class="col-xl-2 col-lg-4 d-flex flex-column flex-shrink-0 p-3 text-bg-dark col-2 dash-sidebar"
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <a href="{{ route('ra.dash') }}" class="nav-link active text-white">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-12 mx-2 mb-4 dash-cards" style="border-radius: 10px; box-shadow: rgb(116 116 116 / 35%) 0px 5px 15px;">
          ...
          <div class="box-part text-center">
            ...
            <a href="{{ url('/ra/user') }}">Δείτε Λεπτομέρειες</a>
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-12 mx-2 mb-4 dash-cards" style="border-radius: 10px; box-shadow: rgb(116 116 116 / 35%) 0px 5px 15px;">
          ...
          <div class="box-part text-center">
            ...
            <a href="{{ url('/ra/service') }}">Δείτε Λεπτομέρειες</a>

...
<div class="container-fluid row">
    ...
    <div class="col-xl-10 col-lg-8 col-md-12 con-ad-dash">
        ...
        <div class="add-ra-main">
            <div class="container">
                <h2 class="text-center mb-2">προσθήκη περιφερειακού διαχειριστή</h2>
                <form action="{{ route('adminRa.update', $ra->id) }}" method="post" enctype="multipart/form-data">
                    {{ method_field("PUT") }}
                    @csrf
                    <div class="row">
                        {{-- personal info --}}
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="fname" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->fname }}" @endif value="{{ old('fname') }}">
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="date" name="dob" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->dob }}" @endif value="{{ old('dob') }}">
                            <span class="text-danger">
                                @error('dob')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="bloodgroup" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->bloodgroup }}" @endif value="{{ old('bloodgroup') }}">
                            <span class="text-danger">
                                @error('bloodgroup')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-check col-xl-3 col-md-6">
                            <label for="exampleInputEmail1" style="margin-top: 23px" class="form-label">
                            </label> <br>
                            <input class="form-check-input mx-2" @if(isset($ra) && $ra->donor == "Οχι") checked @endif type="radio" name="donor" value="Οχι"
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="lvl" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->lvl }}" @endif value="{{ old('lvl') }}">
                            <span class="text-danger">
                                @error('lvl')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="spec" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->spec }}" @endif value="{{ old('spec') }}">
                            <span class="text-danger">
                                @error('spec')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="attr" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->attr }}" @endif value="{{ old('attr') }}">
                            <span class="text-danger">
                                @error('attr')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="grade" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->grade }}" @endif value="{{ old('grade') }}">
                            <span class="text-danger">
                                @error('grade')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="gen" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->gen }}" @endif value="{{ old('gen') }}">
                            <span class="text-danger">
                                @error('gen')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="vat" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->vat }}" @endif value="{{ old('vat') }}">
                            <span class="text-danger">
                                @error('vat')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="doy" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->doy }}" @endif value="{{ old('doy') }}">
                            <span class="text-danger">
                                @error('doy')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="idno" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->idno }}" @endif value="{{ old('idno') }}">
                            <span class="text-danger">
                                @error('idno')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="amka" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->amka }}" @endif value="{{ old('amka') }}">
                            <span class="text-danger">
                                @error('amka')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="memberid" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->memberid }}" @endif value="{{ old('memberid') }}">
                            <span class="text-danger">
                                @error('memberid')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="status1" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->status1 }}" @endif value="{{ old('status1') }}">
                            <span class="text-danger">
                                @error('status1')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="address" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->address }}" @endif value="{{ old('address') }}">
                            <span class="text-danger">
                                @error('address')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="postal" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->postal }}" @endif value="{{ old('postal') }}">
                            <span class="text-danger">
                                @error('postal')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="city" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->city }}" @endif value="{{ old('city') }}">
                            <span class="text-danger">
                                @error('city')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="active" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->active }}" @endif value="{{ old('active') }}">
                            <span class="text-danger">
                                @error('active')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="contact" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->contact }}" @endif value="{{ old('contact') }}">
                            <span class="text-danger">
                                @error('contact')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="tele" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->tele }}" @endif value="{{ old('tele') }}">
                            <span class="text-danger">
                                @error('tele')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->email }}" @endif value="{{ old('value') }}">
                            <span class="text-danger">
                                @error('email')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="edu" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->edu }}" @endif value="{{ old('edu') }}">
                            <span class="text-danger">
                                @error('edu')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="degrees" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->degrees }}" @endif value="{{ old('degrees') }}">
                            <span class="text-danger">
                                @error('degrees')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="school" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->school }}" @endif value="{{ old('school') }}">
                            <span class="text-danger">
                                @error('school')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="eacspec" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->eacspec }}" @endif value="{{ old('eacspec') }}">
                            <span class="text-danger">
                                @error('eacspec')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="eacdesctin" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->eacdesctin }}" @endif value="{{ old('eacdesctin') }}">
                            <span class="text-danger">
                                @error('eacdesctin')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="onlinetrai" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->onlinetrai }}" @endif value="{{ old('onlinetrai') }}">
                            <span class="text-danger">
                                @error('onlinetrai')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="othertrai" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->othertrai }}" @endif value="{{ old('othertrai') }}">
                            <span class="text-danger">
                                @error('othertrai')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="vhrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->vhrs }}" @endif value="{{ old('vhrs') }}">
                            <span class="text-danger">
                                @error('vhrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="healthcarehrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->healthcarehrs }}" @endif value="{{ old('healthcarehrs') }}">
                            <span class="text-danger">
                                @error('healthcarehrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="rescuehrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->rescuehrs }}" @endif value="{{ old('rescuehrs') }}">
                            <span class="text-danger">
                                @error('rescuehrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="nursinghrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->nursinghrs }}" @endif value="{{ old('nursinghrs') }}">
                            <span class="text-danger">
                                @error('nursinghrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="sshrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->sshrs }}" @endif value="{{ old('sshrs') }}">
                            <span class="text-danger">
                                @error('sshrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="traihrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->traihrs }}" @endif value="{{ old('traihrs') }}">
                            <span class="text-danger">
                                @error('traihrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cyvolunteeringhrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cyvolunteeringhrs }}" @endif value="{{ old('cyvolunteeringhrs') }}">
                            <span class="text-danger">
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cyhealthhrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cyhealthhrs }}" @endif value="{{ old('cyhealthhrs') }}">
                            <span class="text-danger">
                                @error('cyhealthhrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cyrescuehrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cyrescuehrs }}" @endif value="{{ old('cyrescuehrs') }}">
                            <span class="text-danger">
                                @error('cyrescuehrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cynursinghrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cynursinghrs }}" @endif value="{{ old('cynursinghrs') }}">
                            <span class="text-danger">
                                @error('cynursinghrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cysshrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cysshrs }}" @endif value="{{ old('cysshrs') }}">
                            <span class="text-danger">
                                @error('cysshrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="cytraininghrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cytraininghrs }}" @endif value="{{ old('cytraininghrs') }}">
                            <span class="text-danger">
                                @error('cytraininghrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="cyeduhrs" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->cyeduhrs }}" @endif value="{{ old('cyeduhrs') }}">
                            <span class="text-danger">
                                @error('cyeduhrs')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="date" name="date" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->date }}" @endif value="{{ old('date') }}">
                            <span class="text-danger">
                                @error('date')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="type" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->type }}" @endif value="{{ old('type') }}">
                            <span class="text-danger">
                                @error('type')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="duration" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->desc }}" @endif value="{{ old('duration') }}">
                            <span class="text-danger">
                                @error('duration')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="desc" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->lname }}" @endif value="{{ old('desc') }}">
                            <span class="text-danger">
                                @error('desc')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-12 col-md-122 mb-3">
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="spknow" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->spknow }}" @endif value="{{ old('spknow') }}">
                            <span class="text-danger">
                                @error('spknow')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xl-6 col-md-12 mb-3">
                            ...
                            <input type="text" name="region" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" @if(isset($ra)) value="{{ $ra->region }}" @endif value="{{ old('region') }}">
                            <span class="text-danger">
                                @error('region')
                                {{ $message }}
                                @enderror

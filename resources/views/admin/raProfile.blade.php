...
<div class="container-fluid row">
  <div class="col-xl-2 col-lg-4 d-flex flex-column flex-shrink-0 p-3 text-bg-dark col-2 dash-sidebar"
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="{{ route('admin.ra') }}" class="nav-link text-white active">
          <svg class="bi pe-none me-2" width="16" height="16">
  ...
  <div class="col-xl-10 col-lg-8 col-md-12 con-ad-dash">
    ...
    {{-- Update pdf modal --}}
    <div class="modal" tabindex="-1" id="updatePdfModal">
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <div class="modal-body d-flex justify-content-center">
            <div class="col-6 mb-3">
              <form id="updatePdfModalForm" action="" method="post" enctype="multipart/form-data">
                @csrf
                <label for="exampleInputEmail1" class="form-label">Ονοματεπώνυμο
                  :</label>
                <input type="file" name="" id="updatePdfModalBody" class="form-control" id="exampleInputEmail1"
    ...
    <div class="container-fluid" style="margin-top: -210px">
        ...
        @endif
          <div class="row">
                ...
                <div class="col-12 d-flex justify-content-center">
                  <div class="dropdown"><span>Εγγραφα:&nbsp
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" name="doc" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                          href="#">Ανέβασμα PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'doc', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                      </ul>
                      @else
                      &nbsp<a class="" name="doc" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                      href="#">Ανέβασμα PDF</a>
                    @endif
                  </div></span>
                </div>
                  ...
                  <div class="dropdown"><span>Αριθμός Διαβατηρίου:&nbsp
                      ...
                      <ul class="dropdown-menu">
                        <li><a name="{{ asset('images/'.$ra->passport) }}" onclick="toggleShowPdf(this)"
                            class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                        <li><a class="dropdown-item" name="passport" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                            href="#">Ανέβασμα PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'passport', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                      </ul>
                      @else
                      Αριθμός Διαβατηρίου:&nbsp<a class="" name="passport" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                  </div></span>
                </div>
                  ...
                  <div class="dropdown"><span>Κωδικός Πρόσβασης:&nbsp
                      ...
                      <ul class="dropdown-menu">
                        <li><a name="{{ asset('images/'.$ra->licenses) }}" onclick="toggleShowPdf(this)"
                            class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                        <li><a class="dropdown-item" name="licenses" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                          href="#">Ανέβασμα PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'licenses', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                      </ul>
                      @else
                      Κωδικός Πρόσβασης:&nbsp<a class="" name="licenses" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                  </div></span>
                </div>
                <div class="col-12">
                  <div class="dropdown"><span>ΒιογραφικόΒιογραφικό:&nbsp
                      @if ($ra->cv != "")
                      <a class="text-primary dropdown-toggle rounded" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Επιλογές
                      ...
                      <ul class="dropdown-menu">
                        <li><a name="{{ asset('images/'.$ra->cv) }}" onclick="toggleShowPdf(this)"
                            class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                        <li><a class="dropdown-item" name="cv" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                          href="#">Ανέβασμα PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'cv', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                      </ul>
                      @else
                      :&nbsp<a class="" name="cv" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                  </div></span>
                </div>
            ...
            <div class="col-lg-6 col-xl-4 col-md-12 border profile-sec-center">
              <div class="row">
                <div class="col-12">
                ...
                <div class="col-12 mt-4" style="position: relative; right: 15px;">
                    ...
                    <div class="dropdown"><span>Βαθμός:&nbsp
                        ...
                        <ul class="dropdown-menu">
                          <li><a name="{{ asset('images/'.$ra->eacdegree) }}" onclick="toggleShowPdf(this)"
                              class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                          <li><a class="dropdown-item" name="eacdegree" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                            href="#">Ανέβασμα PDF</a></li>
                          <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'eacdegree', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                        </ul>
                        @else
                        &nbsp<a class="" name="eacdegree" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                    </div></span>
                  </div>
                    ...
                    <div class="dropdown"><span>ΕΕΣ διάκριση αποδεικτικό:&nbsp
                        ...
                        <ul class="dropdown-menu">
                          <li><a name="{{ asset('images/'.$ra->eacdesctinproof) }}" onclick="toggleShowPdf(this)"
                              class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                          <li><a class="dropdown-item" name="eacdesctinproof" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                            href="#">Ανέβασμα PDF</a></li>
                          <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'eacdesctinproof', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                        </ul>
                        @else
                        ΕΕΣ διάκριση αποδεικτικό:&nbsp<a class="" name="eacdesctinproof" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                    </div></span>
                  </div>
                    ...
                    <div class="dropdown"><span>Εκπαιδεύσεις online Βεβαιώσεις σε pdf:&nbsp
                        ...
                        <ul class="dropdown-menu">
                          <li><a name="{{ asset('images/'.$ra->onlinetraicert) }}" onclick="toggleShowPdf(this)"
                              class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                          <li><a class="dropdown-item" name="onlinetraicert" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                            href="#">Ανέβασμα PDF</a></li>
                          <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'onlinetraicert', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                        </ul>
                        @else
                        Εκπαιδεύσεις online Βεβαιώσεις σε pdf:&nbsp<a class="" name="onlinetraicert" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                    </div></span>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="dropdown"><span>βεβαιώσεις σε pdf:&nbsp
                        @if ($ra->othertraicert != "")
                        <a class="text-primary dropdown-toggle rounded" type="button" data-bs-toggle="dropdown"
                          aria-expanded="false">
                          Επιλογές
                        ...
                        <ul class="dropdown-menu">
                          <li><a name="{{ asset('images/'.$ra->othertraicert) }}" onclick="toggleShowPdf(this)"
                              class="dropdown-item showpdf" href="#">Προβολή PDF</a></li>
                          <li><a class="dropdown-item" name="othertraicert" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                            href="#">Ανέβασμα PDF</a></li>
                          <li><a class="dropdown-item" href="{{ route('ra.profile.pdf.delete', ['name' => 'othertraicert', 'id' => $ra->id]) }}">Διαγραφή</a></li>
                        </ul>
                        @else
                        βεβαιώσεις σε pdf:&nbsp<a class="" name="othertraicert" id="{{ $ra->id }}" data-update="{{ route('ra.profile.pdf.helper', ['id' => $ra->id]) }}" onclick="toggleUploadPdf(this)"
                        href="#">Ανέβασμα PDF</a>
                      @endif
                    </div></span>
                  </div>
...
<script>
  document.getElementById("id").click;
      var showPdf = document.getElementsByTagName("iframe");
      console.log(showPdf);
      function toggleShowPdf(e){
        var src = e.getAttribute("name");
        showPdf.src = src;
        console.log(showPdf.src);
      }
</script>
...
<div class="container-fluid row">
  <div class="col-xl-2 col-lg-4 d-flex flex-column flex-shrink-0 p-3 text-bg-dark col-2 dash-sidebar"
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="{{ route('admin.user') }}" class="nav-link text-white active">
          <svg class="bi pe-none me-2" width="16" height="16">
    ...
    <div class="container-fluid">
        <div class="container">
          ...
          <div class="table-responsive-md">
            <div class="bg-light p-2 mt-4 d-flex justify-content-between align-items-center search-bar">
              <div class="d-flex justify-content-between">
              ...
              <a href="{{ route('adminUser.index') }}" class="mx-2">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" onmouseenter="crud_drop1(this)" onmouseleave="crud_drop2(this)"
                        href="{{ route('admin.user.profile', $user->id) }}">Λεπτομέριες</a></li> {{-- details --}}
                    <li><a class="dropdown-item" onmouseenter="crud_drop1(this)" onmouseleave="crud_drop2(this)"
                        href="{{ route('adminUser.edit', $user->id) }}">Επεξεργασία</a></li> {{-- edit --}}
                    <form action="{{ route('adminUser.show', $user->id) }}" method="GET">
